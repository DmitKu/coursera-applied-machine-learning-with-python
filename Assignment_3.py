...
​
'''
(0.96404867256637172, 0.025000000000000001)
...
​
    ...
    y_scores = model.decision_function(X_test) > -220
...
def answer_five():
    ...
    precision, recall, thresholds = precision_recall_curve(y_test, logreg_predicted)

    fpr_lr, tpr_lr, _ = roc_curve(y_test, logreg_predicted)
...
​
    ...
    grid_search = GridSearchCV(log_reg, param_grid=grid_values, scoring='recall')
